...
def process_message(message, store, tracer, action_generator, table_valid, table_invalid):
    with tracer.start_as_current_span("analyzer") as parent_span:
        ...
        try:
            ...
            if temperature_value < valid_value_range_start or temperature_value > valid_value_range_end:
...
def main():
    ...
    while True:
        ...
        if msg.error():
            ...
            process_message(message_value, store, tracer, action_generator, table_valid, table_invalid)
