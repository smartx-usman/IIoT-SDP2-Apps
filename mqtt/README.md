...
1. Generate sensor data and publish it to an MQTT topic.
2. Get data from the MQTT topic and send it to the Kafka topic.
3. Consume the data from the Kafka topic and analyze it in real-time.
4. Publish the action generated by the analysis step to the MQTT topic.
5. Take care of the generated action.
